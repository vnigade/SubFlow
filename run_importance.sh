...
do
    ...
    do
        ...
        do
            ...
            python subflow.py -mode=si -utilization=${utilization} -subflow_network_no=${subnet_id} -data=mnist_data > logs/importance_${iter}_${utilization}_${epoch}.log 2> /dev/null
