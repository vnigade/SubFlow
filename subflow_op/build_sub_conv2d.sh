...
g++ -std=c++11 -shared -o sub_conv2d.so sub_conv2d.cc sub_conv2d.cu.cc.o  ${TF_CFLAGS[@]} -fPIC -lcuda ${TF_LFLAGS[@]} -O3 -march=native -D_GLIBCXX_USE_CXX11_ABI=0 -D GOOGLE_CUDA=1 -I/cm/shared/apps/cuda10.1/toolkit/current/targets/x86_64-linux/include -L/cm/shared/apps/cuda10.1/toolkit/current/targets/x86_64-linux/lib 
